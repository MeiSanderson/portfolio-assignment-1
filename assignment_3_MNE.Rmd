...
Conclusion (*written in French*):
  ...
  So as the SE of effectiveness differences has doubled (from 1 to 2), the confidence intervals for the incremental cost-effectiveness ratio has also become wider because of it.
